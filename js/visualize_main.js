...
async function getData() {
    ...
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbyOM81BbLXBjAaLqZVzBQ8U1a-28jfEu64lGxA__euXifM4-w6k5cpU4plclfUCdNo0mA/exec', { // Replace with your Google Apps Script URL
            method: 'POST',
            headers: {
