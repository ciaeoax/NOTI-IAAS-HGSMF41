...
async function submitForm() {
    ...
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbzdkcjnZkR8NWCGYKHguORlaRxv1-VFcGcSPEGgvr-DR8lW5poZ3SgkJihNf1IvjWkKTw/exec', { // Replace with your Google Apps Script URL
            method: 'POST',
            headers: {
